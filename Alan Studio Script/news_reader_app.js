const API_KEY = "b1efe1831fff43f5985a10e185b647a6";
let savedArticles = [];
...
intent(`Give me the latest news from united states`, (p) => {
...
intent(`Give me the latest news from Australia`, (p) => {
...
intent(`Give me the latest news from france`, (p) => {
...
intent(`Give me the latest news from germany`, (p) => {
